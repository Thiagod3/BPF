    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <Input 
                    rightIcon={<MaterialCommunityIcons name="lead-pencil" size={30} color="black" />}
                    placeholder="Nome"
                    textAlign="center"
                    inputContainerStyle={{borderBottomWidth: 0}}
                />
                </View><View style={styles.inputBio}>
                <Input 
                    rightIcon={<MaterialCommunityIcons name="lead-pencil" size={30} color="black" />}
                    placeholder="Bio..."
            ...
            <View style={styles.createButton}> 
                <FAB
                    ...
                    onPress={() => {console.log("Levar à team e mudar pra created")}}
                />
            </View>
